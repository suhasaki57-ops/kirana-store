  ...
  try {
    ...
    const productDefs = [
      // Grains & Pulses
      {
        ...
        category: grains._id,
        images: [{ url: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&auto=format&fit=crop', publicId: 'rice-1', isDefault: true }],
      ...
      },
      {
        ...
        category: grains._id,
        images: [{ url: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=600&auto=format&fit=crop', publicId: 'atta-1', isDefault: true }],
      ...
      },
      {
        ...
        category: grains._id,
        images: [{ url: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?w=600&auto=format&fit=crop', publicId: 'dal-1', isDefault: true }],
      ...
      },
      {
        ...
        category: grains._id,
        images: [{ url: 'https://images.unsplash.com/photo-1559561853-08451507cbe7?w=600&auto=format&fit=crop', publicId: 'sugar-1', isDefault: true }],
      ...
      },
      {
        ...
        category: grains._id,
        images: [{ url: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=600&auto=format&fit=crop', publicId: 'salt-1', isDefault: true }],
      ...
      // Spices & Masala
      {
        ...
        category: spices._id,
        images: [{ url: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop', publicId: 'masala-1', isDefault: true }],
      ...
      },
      {
        ...
        category: spices._id,
        images: [{ url: 'https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=600&auto=format&fit=crop', publicId: 'haldi-1', isDefault: true }],
      ...
      // Oils & Ghee
      {
        ...
        category: oils._id,
        images: [{ url: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=600&auto=format&fit=crop', publicId: 'oil-1', isDefault: true }],
      ...
      },
      {
        ...
        category: oils._id,
        images: [{ url: 'https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?w=600&auto=format&fit=crop', publicId: 'ghee-1', isDefault: true }],
      ...
      // Cleaning & Home
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=600&auto=format&fit=crop', publicId: 'detergent-1', isDefault: true }],
      ...
      },
      {
        ...
        category: cleaning._id,
        images: [{ url: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600&auto=format&fit=crop', publicId: 'vim-1', isDefault: true }],
      ...
      },
      {
        ...
        category: cleaning._id,
        images: [{ url: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=600&auto=format&fit=crop', publicId: 'phenyl-1', isDefault: true }],
      ...
      // Personal Care
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1547496502-affa22d38842?w=600&auto=format&fit=crop', publicId: 'soap-1', isDefault: true }],
      ...
      },
      {
        ...
        category: personal._id,
        images: [{ url: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c04?w=600&auto=format&fit=crop', publicId: 'toothpaste-1', isDefault: true }],
      ...
      // Snacks & Beverages
      {
        ...
        category: snacks._id,
        images: [{ url: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=600&auto=format&fit=crop', publicId: 'tea-1', isDefault: true }],
      ...
      },
      {
        ...
        category: snacks._id,
        images: [{ url: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=600&auto=format&fit=crop', publicId: 'biscuit-1', isDefault: true }],
